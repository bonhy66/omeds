        ...
        <div class="form-row">
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input name="birth_date" type="date" class="form-control" id="inputAddress1"
                ...
                <div class="form-group col-md-6">
                    ...
                    <input name="blood_group" type="text" class="form-control" id="inputAddress2"
                ...
                <div class="form-group col-md-6">
                    ...
                    <input name="joining_date" type="date" class="form-control" id="inputAddress5"
                        placeholder="joining_date">
                </div>
                <div class="form-group col-md-6">
                    <label for="inputAddress6">Department</label>
                    <input name="department" type="text" class="form-control" id="inputAddress6"
                        placeholder="Designation">
                </div>

                <div class="form-group col-md-6">
                    <label for="inputAddress7">Designation</label>
                    <input name="designation" type="text" class="form-control" id="inputAddress7"
                        placeholder="Designation">
                </div>
